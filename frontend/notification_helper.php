 ...
 * Include this file in your report_pet_details.php and call the function after creating a lost pet report.
 * 
 * Usage:
 *   require_once 'notification_helper.php';
 *   createLostPetNotifications($pdo, $lost_id, $user_id, $pet_name, $pet_type, $breed, $location, $lost_date, $owner_name);
 * 
 ...
 */
function createLostPetNotifications($pdo, $lost_id, $user_id, $pet_name, $pet_type, $breed, $location = null, $lost_date = null, $owner_name = null) {
    try {
